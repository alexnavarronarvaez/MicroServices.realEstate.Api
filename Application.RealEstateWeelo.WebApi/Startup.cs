...
namespace Application.RealEstateWeelo.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Application.RealEstateWeelo.WebApi", Version = "v1" });
            });
            ...
            CookieTempDataProviderOptions => CookieTempDataProviderOptions.EnableRetryOnFailure()));
            ...
            #endregion Injection Dependency
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Application.RealEstateWeelo.WebApi v1"));
            }
